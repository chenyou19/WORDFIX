    ...
    for index, record in enumerate(summary.table_log_records, start=1):
        lines.extend(
            [
                ...
                f"table_bottom_border_mode: {record.get('table_bottom_border_mode', 'not_applied')}",
                f"table_bottom_border_cell_count: {record.get('table_bottom_border_cell_count', 0)}",
                f"table_bottom_border_xml_verified: {_bool_text(record.get('table_bottom_border_xml_verified', False))}",
                f"table_bottom_border_verify_detail: {record.get('table_bottom_border_verify_detail', '')}",
                f"table_bottom_double_border_applied: {_bool_text(record.get('table_bottom_double_border_applied', False))}",
                f"table_bottom_double_border_cell_count: {record.get('table_bottom_double_border_cell_count', 0)}",
                f"table_bottom_double_border_xml_verified: {_bool_text(record.get('table_bottom_double_border_xml_verified', False))}",
                f"table_bottom_double_border_verify_detail: {record.get('table_bottom_double_border_verify_detail', '')}",
                f"table_top_border_mode: {record.get('table_top_border_mode', 'not_applied')}",
                f"table_top_border_cell_count: {record.get('table_top_border_cell_count', 0)}",
                f"table_top_border_xml_verified: {_bool_text(record.get('table_top_border_xml_verified', False))}",
                f"table_top_border_verify_detail: {record.get('table_top_border_verify_detail', '')}",
                f"first_row_single_cell_title: {_bool_text(record.get('first_row_single_cell_title', False))}",
                f"first_row_single_cell_border_mode: {record.get('first_row_single_cell_border_mode', 'not_applicable')}",
                f"first_row_single_cell_border_xml_verified: {_bool_text(record.get('first_row_single_cell_border_xml_verified', False))}",
                f"first_row_single_cell_border_verify_detail: {record.get('first_row_single_cell_border_verify_detail', '')}",
                f"footer_terminal_bottom_none_applied: {_bool_text(record.get('footer_terminal_bottom_none_applied', False))}",
                f"footer_terminal_bottom_none_cell_count: {record.get('footer_terminal_bottom_none_cell_count', 0)}",
                f"data_rows_outer_left_double_applied: {_bool_text(record.get('data_rows_outer_left_double_applied', False))}",
                f"data_rows_outer_right_double_applied: {_bool_text(record.get('data_rows_outer_right_double_applied', False))}",
                f"data_rows_outer_left_target_count: {record.get('data_rows_outer_left_target_count', 0)}",
                f"data_rows_outer_right_target_count: {record.get('data_rows_outer_right_target_count', 0)}",
                f"data_rows_outer_left_vmerge_owner_target_count: {record.get('data_rows_outer_left_vmerge_owner_target_count', 0)}",
                f"data_rows_outer_right_vmerge_owner_target_count: {record.get('data_rows_outer_right_vmerge_owner_target_count', 0)}",
                f"footer_rows_outer_left_none_applied: {_bool_text(record.get('footer_rows_outer_left_none_applied', False))}",
                f"footer_rows_outer_right_none_applied: {_bool_text(record.get('footer_rows_outer_right_none_applied', False))}",
                f"footer_rows_outer_left_target_count: {record.get('footer_rows_outer_left_target_count', 0)}",
                f"footer_rows_outer_right_target_count: {record.get('footer_rows_outer_right_target_count', 0)}",
                f"outer_vertical_border_policy_xml_verified: {_bool_text(record.get('outer_vertical_border_policy_xml_verified', False))}",
                f"outer_vertical_border_policy_verify_detail: {record.get('outer_vertical_border_policy_verify_detail', '')}",
                f"last_row_physical_cell_count: {record.get('last_row_physical_cell_count', 0)}",
                f"last_row_grid_span_sum: {record.get('last_row_grid_span_sum', 0)}",
                f"last_row_vmerge_states: {record.get('last_row_vmerge_states', 'none')}",
                f"last_row_bottom_edge_target_count: {record.get('last_row_bottom_edge_target_count', 0)}",
                f"table_border_schema_order_valid: {_bool_text(record.get('table_border_schema_order_valid', False))}",
                f"tblPr_child_order: {record.get('tblPr_child_order', '') or 'none'}",
                f"last_row_tcPr_child_orders: {' | '.join(record.get('last_row_tcPr_child_orders', [])) if record.get('last_row_tcPr_child_orders') else 'none'}",
                f"first_row_single_cell_border_adjusted: {_bool_text(record.get('first_row_single_cell_border_adjusted', False))}",
                f"footer_rows_detected: {_bool_text(record.get('footer_rows_detected', False))}",
                f"footer_row_count: {record.get('footer_row_count', 0)}",
                f"footer_top_row_index: {_optional_int_text(record.get('footer_top_row_index'))}",
                f"footer_cell_matches: {' | '.join(record.get('footer_cell_matches', [])) if record.get('footer_cell_matches') else 'none'}",
                f"footer_block_top_border_applied: {_bool_text(record.get('footer_block_top_border_applied', False))}",
                f"footer_internal_top_borders_cleared: {record.get('footer_internal_top_borders_cleared', 0)}",
                f"footer_note_cells_adjusted: {record.get('footer_note_cells_adjusted', 0)}",
                f"footer_base_period_cells_adjusted: {record.get('footer_base_period_cells_adjusted', 0)}",
                f"footer_source_cells_adjusted: {record.get('footer_source_cells_adjusted', 0)}",
...
def write_process_log(output_docx: str | Path, summary: ProcessSummary) -> Path:
    ...
    lines = [
        ...
        f"因巢狀表格保護而完整跳過的表格數：{summary.skipped_nested_tables}",
        f"巢狀表格只調整顏色的表格數：{summary.nested_table_color_only_tables}",
