...
def run_cli(args) -> int:
    ...
    print(f"套用壹、序言前縮排的段落數：{summary.indented_preface_paragraphs}")
    print(f"套用壹、序言前大綱階層的段落數：{summary.outlined_preface_paragraphs}")
...
def parse_args(argv: list[str]):
    ...
    parser.add_argument("--indent-preface", action="store_true", help="啟用第一次「壹、序言」前的編號段落縮排")
    parser.add_argument("--outline-preface", action="store_true", help="啟用第一次「壹、序言」前的編號段落 Word 大綱階層")
