    ...
    try:
        ...
        for record in body_indent_records:
            ...
            logs.append(
                ...
                f"expected_heading_text_start_cm={record.get('expected_heading_text_start_cm')}; "
...
try {{
    ...
    foreach ($record in $records) {{
        try {{
            ...
            Add-Log(("WORD_COM_INDENT_VERIFY: paragraph_index={{0}}; matched_paragraph_index={{1}}; text_preview={{2}}; kind={{3}}; level={{4}}; expected_number_start_cm={{5}}; expected_hanging_cm={{6}}; expected_heading_left_cm={{7}}; expected_heading_text_start_cm={{8}}; expected_body_left_cm={{9}}; expected_first_line_twips={{10}}; xml_font_size={{11}}; xml_font_size_source={{12}}; word_range_font_size={{13}}; word_dominant_font_size={{14}}; word_font_check_pass={{15}}; decision=approved_for_xml_body_indent; word_opened_left_cm={{16}}; word_opened_firstline_cm={{17}}; final_left_cm=not_read; final_firstline_cm=not_read; word_com_LeftIndent_cm={{18}}; word_com_FirstLineIndent_cm={{19}}; word_com_CharacterUnitLeftIndent={{20}}; word_com_CharacterUnitFirstLineIndent={{21}}; word_com_CharacterUnitRightIndent={{22}}; word_com_TabStops_Count={{23}}; word_com_Style_NameLocal={{24}}; word_com_Section_Number={{25}}; section_index={{26}}; section_left_margin_cm={{27}}; section_right_margin_cm={{28}}; paragraph_left_indent_cm={{29}}; absolute_text_start_cm={{30}}; second_fix=python_xml; status={{31}}" -f $record.paragraph_index, $matchIndex, $preview, $kind, $record.level, $record.expected_number_start_cm, $record.expected_hanging_cm, $record.expected_heading_left_cm, $record.expected_heading_text_start_cm, $record.expected_body_left_cm, $record.expected_first_line_twips, $record.xml_font_size, $record.xml_font_size_source, $wordRangeFontSize, $wordDominantFontSize, $wordFontCheckPass, $diag.left_cm, $diag.firstline_cm, $diag.left_cm, $diag.firstline_cm, $diag.char_left, $diag.char_first, $diag.char_right, $diag.tab_count, $diag.style_name, $diag.section_number, $diag.section_number, $diag.section_left_margin_cm, $diag.section_right_margin_cm, $diag.left_cm, $diag.absolute_text_start_cm, $status))
