...
def build_table_log_record(
    *,
    ...
    table_bottom_border_mode: str = "not_applied",
    table_bottom_border_cell_count: int = 0,
    table_bottom_border_xml_verified: bool = False,
    table_bottom_border_verify_detail: str = "",
    ...
    table_top_border_mode: str = "not_applied",
    table_top_border_cell_count: int = 0,
    table_top_border_xml_verified: bool = False,
    table_top_border_verify_detail: str = "",
    first_row_single_cell_title: bool = False,
    first_row_single_cell_border_mode: str = "not_applicable",
    first_row_single_cell_border_xml_verified: bool = False,
    first_row_single_cell_border_verify_detail: str = "",
    footer_terminal_bottom_none_applied: bool = False,
    footer_terminal_bottom_none_cell_count: int = 0,
    data_rows_outer_left_double_applied: bool = False,
    data_rows_outer_right_double_applied: bool = False,
    data_rows_outer_left_target_count: int = 0,
    data_rows_outer_right_target_count: int = 0,
    data_rows_outer_left_vmerge_owner_target_count: int = 0,
    data_rows_outer_right_vmerge_owner_target_count: int = 0,
    footer_rows_outer_left_none_applied: bool = False,
    footer_rows_outer_right_none_applied: bool = False,
    footer_rows_outer_left_target_count: int = 0,
    footer_rows_outer_right_target_count: int = 0,
    outer_vertical_border_policy_xml_verified: bool = False,
    outer_vertical_border_policy_verify_detail: str = "",
    last_row_physical_cell_count: int = 0,
    last_row_grid_span_sum: int = 0,
    last_row_vmerge_states: str = "none",
    last_row_bottom_edge_target_count: int = 0,
    table_border_schema_order_valid: bool = False,
    tblPr_child_order: str = "",
    last_row_tcPr_child_orders: list[str] | None = None,
    ...
    return {
        ...
        "table_bottom_border_mode": table_bottom_border_mode,
        "table_bottom_border_cell_count": table_bottom_border_cell_count,
        "table_bottom_border_xml_verified": table_bottom_border_xml_verified,
        "table_bottom_border_verify_detail": table_bottom_border_verify_detail,
        ...
        "table_top_border_mode": table_top_border_mode,
        "table_top_border_cell_count": table_top_border_cell_count,
        "table_top_border_xml_verified": table_top_border_xml_verified,
        "table_top_border_verify_detail": table_top_border_verify_detail,
        "first_row_single_cell_title": first_row_single_cell_title,
        "first_row_single_cell_border_mode": first_row_single_cell_border_mode,
        "first_row_single_cell_border_xml_verified": (
            first_row_single_cell_border_xml_verified
        ),
        "first_row_single_cell_border_verify_detail": (
            first_row_single_cell_border_verify_detail
        ),
        "footer_terminal_bottom_none_applied": footer_terminal_bottom_none_applied,
        "footer_terminal_bottom_none_cell_count": footer_terminal_bottom_none_cell_count,
        "data_rows_outer_left_double_applied": data_rows_outer_left_double_applied,
        "data_rows_outer_right_double_applied": data_rows_outer_right_double_applied,
        "data_rows_outer_left_target_count": data_rows_outer_left_target_count,
        "data_rows_outer_right_target_count": data_rows_outer_right_target_count,
        "data_rows_outer_left_vmerge_owner_target_count": (
            data_rows_outer_left_vmerge_owner_target_count
        ),
        "data_rows_outer_right_vmerge_owner_target_count": (
            data_rows_outer_right_vmerge_owner_target_count
        ),
        "footer_rows_outer_left_none_applied": footer_rows_outer_left_none_applied,
        "footer_rows_outer_right_none_applied": footer_rows_outer_right_none_applied,
        "footer_rows_outer_left_target_count": footer_rows_outer_left_target_count,
        "footer_rows_outer_right_target_count": footer_rows_outer_right_target_count,
        "outer_vertical_border_policy_xml_verified": (
            outer_vertical_border_policy_xml_verified
        ),
        "outer_vertical_border_policy_verify_detail": (
            outer_vertical_border_policy_verify_detail
        ),
        "last_row_physical_cell_count": last_row_physical_cell_count,
        "last_row_grid_span_sum": last_row_grid_span_sum,
        "last_row_vmerge_states": last_row_vmerge_states,
        "last_row_bottom_edge_target_count": last_row_bottom_edge_target_count,
        "table_border_schema_order_valid": table_border_schema_order_valid,
        "tblPr_child_order": tblPr_child_order,
        "last_row_tcPr_child_orders": list(last_row_tcPr_child_orders or []),
